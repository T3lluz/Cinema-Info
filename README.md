...
The Movies tab shows **IMDb**, **Letterboxd** and **Tomatometer** ratings
(with logos) when the snapshot could find them. Letterboxd and Rotten
Tomatoes are read from their public film pages; IMDb needs an
